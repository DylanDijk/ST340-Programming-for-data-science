...
```
```{r}
s = svm(y ~., d, kernel="polynomial", degree=2, coef0 = 1)
paste("accuracy", mean(predict(s,d)==y),"   ||   ", "Number of support vectors:", nrow(s$SV))
plot(s,d, grid = 200,asp=1, col = c("orange","grey74"))
```
